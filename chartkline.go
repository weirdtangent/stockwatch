...
func chartHandlerTickerDailyKLine(deps *Dependencies, sublog zerolog.Logger, ticker Ticker, exchange *Exchange, dailies []TickerDaily, webwatches []WebWatch) template.HTML {
	nonce := deps.nonce
